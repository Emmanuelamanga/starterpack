...
@section('content')
<div class="card">
    <div class="card-header text-center"><strong class="">Title :</strong> {{$subcat->getSubcategory($item->subcatid)->sub_title ?? "No Title" }} <strong>&nbsp;&nbsp; Description : </strong>{{$subcat->getSubcategory($item->subcatid)->sub_desc ?? 'No Description'}}</div>
    <div class="card-body">
