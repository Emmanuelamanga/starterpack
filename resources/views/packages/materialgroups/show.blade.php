        ...
        <table id="example" class="table table-bordered table-condensed table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{$materialGroup->room_name}}</td>
                </tr>
                <tr>
                    <th>Description</th>
                    <td>{{$materialGroup->room_desc}}</td>
                </tr>
                <tr>
                    <th>Created</th>
                    <td>{{$materialGroup->created_at}}</td>
                </tr>
                <tr>
                    <th>Updated</th>
                    <td>{{$materialGroup->updated_at}}</td>
                </tr>
                <tr>
                    <th>Author</th>
                    <td>{{$materialGroup->room_authorid}}</td>
                </tr>
                <tr>
                    <th>Operation</th>
                    <td>
