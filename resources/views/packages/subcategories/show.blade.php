    ...
    <div class="card-header">VIEW SUB-CATEGORY</div>
        <div class="card-body">
            <table id="example"class="table table-bordered table-condensed table-striped">
                    ...
                    <tbody><tr><th>SN</th><td>{{$subcat->id}}</td></tr>
                            <tr><th>Category</th><td>{{$subcat->catid}}</td></tr>
                            <tr><th>Sub-Category</th><td>{{$subcat->sub_title}}</td></tr>
                            <tr><th>Description</th><td>{{$subcat->sub_desc}}</td></tr>
                            <tr> <th>Created</th><td>{{$subcat->created_at}}</td></tr>
                            <tr> <th>Updated</th><td>{{$subcat->updated_at}}</td></tr>
